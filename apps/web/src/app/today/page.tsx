      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            ...
            <p className="text-slate-400">Daily recommendations and progress</p>
            <p className="text-yellow-400 mt-4">
              Daily features temporarily disabled during deployment fixes.
            </p>
          </div>
          
          <div className="bg-slate-900 rounded-xl p-8 border border-slate-700">
            <p className="text-slate-300 mb-4">
              Daily recommendations, goals, and brainprint tracking are being updated.
            </p>
            <Link
              href="/"
